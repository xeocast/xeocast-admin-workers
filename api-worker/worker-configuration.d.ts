/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: d8610c5ece2ef096869fb89d7b3d3869)
...
declare namespace Cloudflare {
	interface Env {
		...
		R2_REGION: string;
		EPISODE_PROJECTS_BUCKET_NAME: string;
