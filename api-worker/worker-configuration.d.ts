/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: dce23637f350bfeabceb789c1be3f8b4)
// Runtime types generated with workerd@1.20250525.0 2025-05-22 
declare namespace Cloudflare {
	interface Env {
		ENVIRONMENT: string;
		PODCAST_PROJECTS_BUCKET: R2Bucket;
		DB: D1Database;
		ASSETS: Fetcher;
	}
}
